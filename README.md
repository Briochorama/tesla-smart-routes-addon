...
> **First time?** See the [integration README](https://github.com/Briochorama/tesla-smart-routes#setup-overview) for the full setup sequence — it tells you when to come back here.
